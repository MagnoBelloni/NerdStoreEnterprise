...
namespace NSE.Identidade.API.Services
{
    public class AuthenticationService
    {
        ...
        private readonly AppTokenSettings _AppSettingsSettings;
        ...
        public AuthenticationService(
            ...
            IOptions<AppTokenSettings> AppSettingsSettings,
            ...
            IAspNetUser aspNetUser)
        {
            ...
            _AppSettingsSettings = AppSettingsSettings.Value;
        ...
        private async Task<RefreshToken> GerarRefreshToken(string email)
        {
            ...
            {
                Username = email,
                ExpirationDate = DateTime.UtcNow.AddHours(_AppSettingsSettings.RefreshTokenExpiration)
            };
